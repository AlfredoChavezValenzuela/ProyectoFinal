...
class Medico(models.Model):
    ...
    crm = models.CharField(verbose_name="CMP", max_length=200)
...
def validar_dia(value):
    ...
    if value < today:
        raise ValidationError('No es posible elegir una fecha atrasada.')
...
class Agenda(models.Model):
    ...
    dia = models.DateField(help_text="Ingrese una fecha para el calendario", validators=[validar_dia])
